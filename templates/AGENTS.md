...
- `multi-file` — copy plans/_TEMPLATE.md → plans/<slug>.md and list it in STATE.md In flight. Plan in a fresh context; execute in another. The plan is the entire handoff.
