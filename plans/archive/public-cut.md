...
| 7 Tag + release published         | `git ls-remote --tags origin` shows v0.1.0; push output; release URL (or the recorded manual step)                                       | deferred: post-push — replaced by the evidence commit |
| 8 Cold clone installs             | Fresh clone at v0.1.0, README-only install transcript summary, fast gate green, issue form renders                                       | deferred: post-push — replaced by the evidence commit |
